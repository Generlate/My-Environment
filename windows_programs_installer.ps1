...
#check if i want this typescript version
...
Write-Host "Installing TypeScript"; npm install -g typescript
...
# couldn't figure out setting wallpaper

Write-Host "Turning powershell Terminal window transparent"
